...
describe('ThreeDModuleSpec', () => {
  ...
  it('should have the correct width', () =>
    ...
    expect(testee.width).toBe(18.123));

  it('should have the correct height', () =>

    expect(testee.height).toBe(19));

  it('should have the correct depth', () =>

    expect(testee.depth).toBe(20));

  it('should count \'endfacet\' as triangles', () =>

    expect(testee.triangleCount).toBe(2));
});